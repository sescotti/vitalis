...
//});
//
//VitalisApp.module("Vitalis.Views", function(Views, App, Backbone, Marionette, $, _){
//
//    var Vitalis = App.module('Vitalis');
//
//    Views.HeaderView = Marionette.ItemView.extend({
//        template: Vitalis.templates.header
//    });
//
//    Views.ContentView = Marionette.ItemView.extend({
//        template: Vitalis.templates.content
//    });
//
//    Views.FooterView = Marionette.ItemView.extend({
//        template: Vitalis.templates.footer
//    });
//
//});
//
